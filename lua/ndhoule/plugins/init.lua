return {
  spec = {
    { import = "ndhoule.plugins.colorscheme" },
    ...
    { import = "ndhoule.plugins.syntax" },
    { import = "ndhoule.plugins.testing" },
    { import = "ndhoule.plugins.treesitter" },
    { import = "ndhoule.plugins.ui" },
    { import = "ndhoule.plugins.vcs" },
  },
}
