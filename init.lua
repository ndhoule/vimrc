...
return require("packer").startup({
  function()
    ...
    use({ "b3nj5m1n/kommentary", commit = "533d768a140b248443da8346b88e88db704212ab" })
    ...
    use({
      "tpope/vim-fugitive",
      commit = "535389b9a64be18349394c192bcf0348c0dee64e",
      requires = {
    ...
    use({
      "sainnhe/sonokai",
      commit = "c2f8a7259e4b67fb4d0242afababbb1dda3285a3",
      config = function()
